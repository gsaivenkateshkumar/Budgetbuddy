    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-4">
      <form action="/validate" method="GET" className="flex flex-col gap-2 sm:flex-row" role="search">
        ...
        <input
          ...
          className="w-full flex-1 rounded-xl border border-white/[0.12] bg-white/[0.06] px-4 py-3 text-base text-white shadow-sm outline-none placeholder:text-slate-400 focus:border-violet-400/60 focus:ring-2 focus:ring-violet-500/30"
        />
        <button
          type="submit"
